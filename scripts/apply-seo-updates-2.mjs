// Same as apply-seo-updates.mjs, second batch — reads seo-updates-2.json.
import fs from 'node:fs'
import path from 'node:path'

const updates = JSON.parse(fs.readFileSync(new URL('./seo-updates-2.json', import.meta.url)))
