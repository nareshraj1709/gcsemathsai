...
export const PREDICTED_PAPER_FAMILIES: PredictedPaperFamily[] = [
  {
    ...
    tier: 'Higher',
    year: 2026,
    title: 'Edexcel GCSE Maths Higher — Practice Papers 2026',
    shortTitle: 'Edexcel Higher · 2026',
    metaTitle: 'Edexcel GCSE Maths Higher Practice Papers — Paper 2 & Paper 3 (2026)',
    metaDescription: 'Five Paper-2 style and five Paper-3 style practice papers for Edexcel GCSE Maths Higher (1MA1), written by GCSEMathsAI from the published 2026 specification. Full mark schemes, worked solutions, instant PDF download. Independent revision resource, not affiliated with Pearson Edexcel.',
    keywords: [
      'edexcel gcse maths practice papers',
      'gcse maths 2026 practice papers',
      'edexcel higher practice papers',
      'gcse maths paper 2 practice',
      'gcse maths paper 3 practice',
      'edexcel 1ma1 practice',
    ],
    heroBlurb: 'Ten practice papers for Edexcel 1MA1 Higher in 2026 — five Paper-2 style, five Paper-3 style. Carefully written by our team from the published specification, with full mark schemes and worked solutions.',
  ...
  },
  {
    ...
    tier: 'Foundation',
    year: 2026,
    title: 'Edexcel GCSE Maths Foundation — Practice Papers 2026',
    shortTitle: 'Edexcel Foundation · 2026',
    metaTitle: 'Edexcel GCSE Maths Foundation Practice Papers — Paper 2 & Paper 3',
    metaDescription: 'Ten Foundation-tier calculator practice papers for Edexcel GCSE Maths (1MA1). Five Paper-2 style, five Paper-3 style. Full mark schemes, worked solutions, instant PDF download.',
    keywords: [
      ...
      'gcse maths grade 1 to 5 practice',
    ],
    heroBlurb: 'Ten Foundation-tier calculator practice papers for Edexcel 1MA1 — five Paper-2 style, five Paper-3 style. Calibrated to the grade 1–5 difficulty curve with full mark schemes and worked solutions.',
