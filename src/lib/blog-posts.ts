...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'cta', text: 'Practice grade-9 style questions with instant instant feedback — timed papers available for AQA, Edexcel and OCR.', href: '/papers', label: 'Try a timed paper →' },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'cta', text: 'Practise any AQA topic with instant instant marking — Foundation and Higher questions available.', href: '/learn', label: 'Start topic practice →' },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'h2', text: 'How online practice can help you hit your target' },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'p', text: 'The gap between practising a question and understanding why you got it wrong is where most students stall. Traditional marking requires a teacher or a trip through the mark scheme. smart marking gives you instant, specific feedback on exactly what you did wrong and how to fix it — which is the fastest route to improvement.' },
      { type: 'cta', text: 'Practice any GCSE Maths topic and get instant instant feedback — specific, actionable, and available 24/7.', href: '/learn', label: 'Start practising →' },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'cta', text: 'Test yourself on GCSE Maths formulas with expert-marked practice questions — see exactly where your gaps are.', href: '/learn', label: 'Practice now →' },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    slug: 'how-smart-revision-is-changing-gcse-maths-2025',
    title: 'How Smart Revision Tools Are Changing GCSE Maths in 2025',
    excerpt: 'From personalised question generation to instant marking, modern revision tools are transforming how students prepare for GCSE Maths. Here is what is actually changing and what still matters.',
    category: 'How it works',
    categoryColour: 'amber',
    author: 'GCSEMathsAI Team',
    date: '15 February 2025',
    readMins: 6,
    metaDescription: 'How smart revision tools are transforming GCSE Maths revision in 2025 — personalised practice, instant marking and adaptive learning.',
    keywords: ['GCSE maths revision tools', 'smart maths revision GCSE', 'online GCSE maths revision', 'GCSE maths practice online'],
    blocks: [
      { type: 'p', text: 'The way students revise for GCSE Maths has not fundamentally changed in decades: read notes, watch videos, do past papers, get feedback from a teacher or parent. The last step — getting feedback — has always been the bottleneck. Teachers are stretched, parents often cannot help, and mark schemes require interpretation. Modern revision platforms are changing this.' },
      ...
      { type: 'h2', text: 'What instant marking does' },
      { type: 'p', text: 'Modern marking systems can read a student\'s written answer, compare it to a mark scheme, identify specific errors, award the correct marks (including partial credit), and explain in plain English what needs to change. This is not basic auto-grading — it is genuine mathematical reasoning applied to student work.' },
      { type: 'p', text: 'At GCSEMathsAI, our marking system is calibrated to each exam board: AQA marking applies strict method marks; Edexcel marking allows follow-through marks; OCR marking credits alternative valid methods. The feedback is specific, immediate, and based on the same criteria a real examiner would use.' },
      { type: 'h2', text: 'Personalised question generation' },
      { type: 'p', text: 'Smart platforms can generate new practice questions on demand — tailored to a specific topic, difficulty level, and exam board style. This means a student who has worked through every available Pythagoras question on past papers can get ten more, calibrated to their level, without waiting for a new paper to be published.' },
      { type: 'h2', text: 'What technology cannot replace' },
      { type: 'ul', items: [
      ...
      { type: 'h2', text: 'How to use revision tools most effectively' },
      { type: 'p', text: 'Think of online revision tools as a patient, always-available practice partner. Use them for the practice-feedback loop: do a question, get instant feedback, understand the correction, try again. Use your teacher for conceptual explanations of topics you genuinely do not understand. Use past papers for simulated exam conditions.' },
      { type: 'ul', items: [
        'Use online practice for topics where you need volume of practice (equations, sequences, percentage problems)',
        'Use instant marking to understand exactly where marks are being dropped',
        'Use timed practice papers to simulate exam conditions and get a grade estimate',
        'Continue to revise with teachers and textbooks for understanding new concepts',
      ] },
      { type: 'cta', text: 'Try expert-marked GCSE Maths practice — instant feedback on every answer, for AQA, Edexcel and OCR.', href: '/learn', label: 'Start practising →' },
    ],
  },
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    readMins: 6,
    metaDescription: 'How to use Edexcel GCSE Maths past papers (1MA1) effectively in 2025. Download links, revision strategy, mark scheme tips and how online practice papers can fill the gaps.',
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'ul', items: [
        ...
        'Evening (30 mins): Algebra practice questions with instant marking — focus on questions you got wrong',
      ] },
      ...
      { type: 'cta', text: 'Follow this plan with smart practice — get instant feedback on every question, 24/7.', href: '/learn', label: 'Start Day 1 practice →' },
    ],
  },
