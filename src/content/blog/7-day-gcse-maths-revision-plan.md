---
title: "7-Day GCSE Maths Revision Plan: What to Revise Each Day"
description: "A structured 7-day GCSE Maths revision plan covering all five topic areas. Works for both Foundation and Higher tier, with daily session plans, timed practice targets and links to resources for AQA, Edexcel and OCR students."
date: "17 March 2026"
dateISO: "2026-03-17"
...
readMins: 8
keywords: ["gcse maths revision plan", "7 day gcse maths revision", "gcse maths revision schedule", "gcse maths revision timetable", "gcse maths last minute revision", "gcse maths week before exam", "gcse maths study plan"]
---
...
- Access to [topic practice questions](/learn) for follow-up practice

---

## Day 1 — Number and Percentages

**Morning session (45 min): Core Number**
Focus: Fractions, decimals, ordering numbers, standard form, powers and roots, BIDMAS.
...
**Afternoon session (45 min): Percentages**
This topic appears on every GCSE Maths paper. Make sure you can do all three types:
1. **Percentage of an amount:** What is 35% of £420?
2. **Percentage change:** A price rises from £80 to £94. What is the percentage increase?
...
**Morning session (30 min): Quick review**
Redo 3–5 of yesterday's wrong questions. If you can do them correctly now, those gaps are closed.
...
Solve: 2x + 3y = 13 and 5x − 3y = 1

Add the equations: 7x = 14 → x = 2. Substitute: 4 + 3y = 13 → y = 3.

For deeper practice on any algebra topic, [use our topic selector](/learn) and choose Algebra → your specific subtopic.

---

## Day 3 — Algebra (Graphs and Sequences)
...
**Session 1 (45 min): Area, perimeter and volume**
This is one of the highest-mark areas across both tiers. Cover:
...
A shape consists of a rectangle 8 cm × 5 cm with a semicircle on top (diameter 8 cm). Find the total area.

Rectangle: 8 × 5 = 40 cm²
Semicircle: ½ × π × 4² = ½ × π × 16 = 25.13 cm²
Total = 65.1 cm² (to 1 d.p.)
...
- Higher: Circle theorems — work through all eight (see our [circle theorems guide](/blog/circle-theorems-gcse))
...
**Practice approach:**
Work through 10 questions — 5 finding the hypotenuse, 5 finding a shorter side. Time yourself: each question should take under 2 minutes.
...
## Day 6 — Statistics, Probability and Ratio
