...
Iteration is one of those GCSE topics that always looks intimidating at first glance, then turns out to be one of the most procedural topics on the Higher paper. You follow the same set of steps every time. Once you've practised three or four iteration questions, the rest of them feel routine.

This guide walks you through the entire technique with the kind of worked examples you'll see on AQA, Edexcel and OCR Higher papers.
...
## Why You'd Need Iteration

Some equations have nice solutions you can find with algebra — by factorising, by using the quadratic formula, or by rearranging. Examples: $x^2 + 5x + 6 = 0$ factorises cleanly. $2x − 3 = 7$ rearranges in one step.

Other equations don't have nice algebraic solutions. Try $x^3 - 4x + 2 = 0$. The quadratic formula doesn't apply because the equation is cubic, and the answer isn't a whole number. You can't factorise it.

For equations like this, iteration lets you find an **approximate** solution that's accurate to as many decimal places as you need.

## The Iteration Recipe — Same Three Steps Every Time

Every iteration question on a GCSE paper follows the same three steps.

**Step 1: Use the iterative formula you've been given.** The question usually gives you a formula in the form $x_{n+1} = \text{(something involving } x_n \text{)}$.
...
That's it. Once you've done this three or four times, it becomes mechanical.

## Worked Example 1 — A Standard Iteration Question

The equation $x^3 - 4x - 2 = 0$ has a root between 2 and 3. Using the iterative formula

$$x_{n+1} = \sqrt[3]{4x_n + 2}$$

and starting with $x_0 = 2$, find this root to 3 decimal places.

**Step 1: Substitute $x_0 = 2$.**

$x_1 = \sqrt[3]{4 \times 2 + 2} = \sqrt[3]{10} = 2.15443...$

**Step 2: Substitute $x_1$.**

$x_2 = \sqrt[3]{4 \times 2.15443 + 2} = \sqrt[3]{10.61773} = 2.19942...$

**Step 3: Substitute $x_2$.**

$x_3 = \sqrt[3]{4 \times 2.19942 + 2} = \sqrt[3]{10.79767} = 2.21181...$

**Step 4: Substitute $x_3$.**

$x_4 = \sqrt[3]{4 \times 2.21181 + 2} = \sqrt[3]{10.84724} = 2.21520...$

**Step 5: Substitute $x_4$.**

$x_5 = \sqrt[3]{4 \times 2.21520 + 2} = \sqrt[3]{10.86080} = 2.21612...$

**Step 6: Substitute $x_5$.**

$x_6 = \sqrt[3]{4 \times 2.21612 + 2} = \sqrt[3]{10.86449} = 2.21637...$
...
The equation $x^3 - x - 1 = 0$ has a solution near $x_0 = 1$. Using

$$x_{n+1} = \frac{1}{x_n^2 - 1} \quad \text{... actually this won't work — let's use the more stable form:}$$
...
$x_1 = \sqrt[3]{1 + 1} = \sqrt[3]{2} = 1.25992$

$x_2 = \sqrt[3]{1.25992 + 1} = \sqrt[3]{2.25992} = 1.31229$

$x_3 = \sqrt[3]{1.31229 + 1} = \sqrt[3]{2.31229} = 1.32235$

$x_4 = \sqrt[3]{1.32235 + 1} = \sqrt[3]{2.32235} = 1.32426$

$x_5 = \sqrt[3]{1.32426 + 1} = \sqrt[3]{2.32426} = 1.32463$

$x_6 = \sqrt[3]{1.32463 + 1} = \sqrt[3]{2.32463} = 1.32470$

$x_7 = \sqrt[3]{1.32470 + 1} = \sqrt[3]{2.32470} = 1.32471$
...
Sometimes an iteration doesn't converge — the values bounce around or grow without bound. If this happens on a GCSE paper, you've probably:
- Used the wrong starting value
- Made an arithmetic error
- Misread the iterative formula

If you spot the values diverging, **stop, check your formula and your starting value**, and restart. The exam will give you an iterative formula that converges; if yours isn't, something has gone wrong.
...
Most GCSE iteration questions converge in 4–6 iterations to 3 decimal places. If you've done 8 iterations and consecutive values still don't agree, double-check your formula and arithmetic.
...
Iteration usually appears as a 4–6 mark question on Paper 2 or Paper 3 (the calculator papers). It's a topic that students who panic at it lose 6 marks on, and students who practise it pick up 6 marks on. Few topics offer such consistent, recoverable marks.
...
**Stopping too soon.** If you've only done two iterations, you haven't shown convergence. Do at least 4–5.

**Forgetting calculator mode.** Some calculators interpret $\sqrt[3]{x}$ differently. On a Casio fx-83/85, use the **shift + cube root** key, not $x^{1/3}$ unless you're confident with brackets.
