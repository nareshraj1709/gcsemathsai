---
title: "Histograms and Frequency Density — GCSE Higher Maths Complete Guide"
description: "A complete GCSE Higher tier guide to histograms. Learn frequency density, drawing histograms from grouped data, reading histograms, and answering the most common exam questions."
date: "16 May 2026"
dateISO: "2026-05-16"
category: "Statistics"
...
readMins: 10
keywords: ["histograms gcse", "frequency density gcse", "gcse maths histograms", "drawing histograms gcse", "histograms higher tier", "histograms revision gcse", "histogram exam questions gcse"]
---

Histograms are the statistics topic students most often confuse with bar charts. They look similar — but they're not the same chart, and at GCSE Higher tier the difference is the whole point of the question. This guide explains exactly what makes a histogram a histogram, how frequency density works, and how to answer every question type that appears on the Higher paper.
...
A **histogram** shows the frequency distribution of continuous numerical data grouped into class intervals — and here's where it diverges from a bar chart:

1. The class intervals can be **different widths**
2. The height of each bar is **frequency density**, not frequency
...
That's it. Memorise that formula. Every histogram question — without exception — uses it.

### Example

A class interval of length 10 cm has a frequency of 30 students. Its frequency density is $30 \div 10 = 3$.

Another class interval of length 5 cm has a frequency of 25 students. Its frequency density is $25 \div 5 = 5$.
...
This is the most common histogram question on Higher papers. You're given a frequency table with class intervals (often of varying widths) and asked to draw the histogram.
...
- $0 < h \leq 10$: width 10
- $10 < h \leq 20$: width 10
- $20 < h \leq 40$: width 20
- $40 < h \leq 60$: width 20
- $60 < h \leq 100$: width 40
...
|-------|-----------|-------|-------------------|
| $0 < h \leq 10$ | 8 | 10 | 0.8 |
| $10 < h \leq 20$ | 14 | 10 | 1.4 |
| $20 < h \leq 40$ | 30 | 20 | 1.5 |
| $40 < h \leq 60$ | 24 | 20 | 1.2 |
| $60 < h \leq 100$ | 16 | 40 | 0.4 |
...
The other big question type goes the other way: you're given the histogram and asked to find the frequency for a class interval, or for a custom range.
...
1. Identify which classes the range covers
2. Take only the relevant portion of each bar
3. Multiply each portion's width by the frequency density

**Continued example:** The bar for ages 25–30 has frequency density 8. The bar for ages 30–40 has frequency density 5.

Ages 27–30: that's 3 years of the first bar. Frequency $= 8 \times 3 = 24$.

Ages 30–35: that's 5 years of the second bar. Frequency $= 5 \times 5 = 25$.
...
1. Find the total frequency by adding all the frequencies together (or multiplying each frequency density by its class width)
2. Halve it to find the position of the median
3. Work out which class the median falls in
4. Estimate where in that class by interpolation

### Worked Example

Total frequency from the plant heights table earlier: $8 + 14 + 30 + 24 + 16 = 92$.

The median is at position $92 \div 2 = 46$.
...
The median sits inside the class $20 < h \leq 40$ (because 22 < 46 ≤ 52).

How far into this class? We need 46 − 22 = 24 more values. The class has 30 values spread across a width of 20.

Estimated median = $20 + \frac{24}{30} \times 20 = 20 + 16 = 36$ cm.

## Common Question Types Summarised

**Type 1: Complete the table or histogram.** You're given some data and asked to fill in the missing frequencies or frequency densities. Use the formula in both directions.
...
**Type 4: Compare two distributions.** You'll have two histograms or two tables. Compare them using mean, median, range and the visual shape (skewed, symmetric, where the peak is).
...
**Using frequency on the y-axis instead of frequency density.** This is the most common error. If your class widths differ, the chart you draw is not a histogram — it's a misleading bar chart. Always use frequency density.

**Wrong class width.** Read the boundaries carefully. The class $20 < h \leq 40$ has width 20, not 40 and not 19.

**Forgetting the "estimate" caveat.** When you read data from inside a class, you're estimating. Mark schemes look for the word "estimate" in your final answer.
...
**Sloppy graph drawing.** If your bars don't touch the right values, you lose marks. Use a ruler. Label the axes. Title the histogram.
...
1. A class $0 < x \leq 30$ has frequency 60. What's its frequency density?
2. A class $30 < x \leq 35$ has frequency density 12. What's its frequency?
3. A class $40 < x \leq 60$ has frequency density 5. How many values lie in the range $50 < x \leq 60$?

**Answers:** (1) 2; (2) 60; (3) 50.

If those felt fast, you've got the core formula. The rest is just careful reading.
...
- [GCSE Maths Foundation vs Higher](/blog/gcse-maths-foundation-vs-higher-which-tier)
- [GCSE Maths Topics Complete List](/blog/gcse-maths-topics-complete-list)
