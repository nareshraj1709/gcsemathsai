---
title: "Direct and Inverse Proportion at GCSE Maths — Complete Guide"
description: "A clear GCSE guide to direct and inverse proportion. Covers algebraic proportion (y ∝ x, y ∝ 1/x), proportion graphs, finding constants of proportionality, and worked examples for AQA, Edexcel and OCR."
date: "16 May 2026"
dateISO: "2026-05-16"
category: "Algebra"
categoryColour: "rose"
...
readMins: 9
keywords: ["direct proportion gcse", "inverse proportion gcse", "proportion gcse maths", "y proportional to x", "gcse proportion examples", "proportion higher tier gcse", "constant of proportionality"]
---
...
1. Rewrite the proportion statement as an equation with a constant k
2. Use given values to find k
3. Use the equation with k to answer the question
...
1. Write the equation in the form y = k × (something)
2. Substitute the given pair of values
3. Solve for k
...
1. If y is directly proportional to x and y = 12 when x = 4, what is y when x = 9?
2. If p is inversely proportional to q and p = 6 when q = 5, what is p when q = 15?
3. If A is directly proportional to r² and A = 50 when r = 5, what is A when r = 8?
...
- [Simultaneous equations](/blog/simultaneous-equations-gcse) — sometimes the constant of proportionality appears in a system you have to solve
- [How to Solve Quadratic Equations](/blog/how-to-solve-quadratic-equations-gcse) — proportion to x² frequently rearranges into a quadratic
- [GCSE Maths Formulas You Must Know](/blog/gcse-maths-formulas-you-must-know) — the four standard proportion equations are core
