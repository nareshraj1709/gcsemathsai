---
title: "Simultaneous Equations GCSE: Three Methods With Fully Worked Examples"
description: "How to solve simultaneous equations at GCSE — elimination, substitution and graphical methods explained with step-by-step worked examples. Covers Foundation and Higher, including one linear and one quadratic (Higher only)."
date: "17 March 2026"
dateISO: "2026-03-17"
category: "Algebra"
categoryColour: "blue"
...
readMins: 10
keywords: ["simultaneous equations gcse", "how to solve simultaneous equations gcse", "simultaneous equations gcse questions", "elimination method gcse", "substitution method gcse", "simultaneous equations higher gcse", "linear simultaneous equations gcse"]
---
...
### Method
1. Choose 3 x-values for each equation and calculate the corresponding y-values.
2. Plot both lines on the same axes.
3. Read the coordinates of the intersection point — this is the solution (x, y).

### Worked Example 5 — Graphical
*Solve graphically: y = x + 2 and y = 4 − x*

For y = x + 2: when x = 0, y = 2; when x = 2, y = 4; when x = −1, y = 1.
For y = 4 − x: when x = 0, y = 4; when x = 2, y = 2; when x = 4, y = 0.
