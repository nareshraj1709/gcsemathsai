...
export default function StudyPage() {
  ...
  // Count how many subtopics have written content
                ...
                <div style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {subtopics.map(st => {
                    ...
                    return (
                      <button
                        key={st}
                        onClick={() => ready && handleSubtopic(topicName, st)}
                        style={{
                          display: 'flex', alignItems: 'center', gap: 12,
                          padding: '12px 14px', borderRadius: 12,
                          cursor: ready ? 'pointer' : 'default',
                          border: `1.5px solid ${ready ? meta.border : '#F3F4F6'}`,
                          background: ready ? '#fff' : '#FAFAFA',
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          background: ready ? meta.light : '#F3F4F6',
                          fontSize: 14,
                        }}>
                          {ready ? '📖' : '🔜'}
                        </div>
