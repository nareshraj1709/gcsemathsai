...
const CONTACT_FAQS = [
  ...
  { q: 'Can my teacher set up accounts for a whole class?', a: 'Not yet — but this is on our roadmap. Email us at enquiries@gcsemathsai.co.uk.' },
  ...
  { q: 'How do I delete my account?', a: 'Email enquiries@gcsemathsai.co.uk with the subject "Delete my account".' },
]
