    ...
    <main className="min-h-screen bg-white">
      <nav className="border-b border-gray-100 px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 text-purple-700 font-semibold">Log in</button>
          <button className="px-4 py-2 bg-purple-700 text-white rounded-lg font-semibold">Start free</button>
        </div>
      </nav>
      <section className="bg-gradient-to-br from-purple-50 to-purple-100 px-8 py-24 text-center">
        ...
        <button className="px-8 py-4 bg-purple-700 text-white rounded-xl text-lg font-bold shadow-lg">
