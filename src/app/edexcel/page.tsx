...
const HIGHER_GB = [['9','200â€“220'],['8','178â€“202'],['7','155â€“180'],['6','122â€“148'],['5','90â€“115'],['4','58â€“84']]
const FOUNDATION_GB = [['5','150â€“172'],['4','110â€“135'],['3','75â€“98']]
const STYLE_NOTES = [
    ...
    <main style={{ minHeight: '100vh', background: 'var(--cream)' }}>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: 'clamp(32px, 5vw, 56px) 20px 0' }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--ink-3)', lineHeight: 1.65, marginTop: 16 }}>
          Edexcel matches AQA&apos;s structure: three 80-mark papers. Foundation (grades 1â€“5) and Higher (grades 4â€“9) sit different question sets. The non-calculator paper is sat first.
        </p>
      </section>
